...
parser.add_argument('--data', type=str, default='../../data/energy/energydata_complete.csv', help='location of the data file')
...
parser.add_argument('--CNN_kernel', type=int, default=3, help='kernel size o    f CNN')
parser.add_argument('--input_length', type=int, default=24, help='number of     10 minutes')
...
df = df[['T1', 'T2', 'T3', 'T4', 'T5', 'T6', 'T7', 'T8', 'T9', 'T_out', 'Windspeed', 'RH_out', 'Tdewpoint', 'Appliances']]
df = df.values
df_train = df[:13815]
df_valid = df[13815:13815 + 1974]
df_test = df[13815 + 1974:]
#df_test = df[-2730:]
...
num_hr = 6 * 24 * 7 + args.input_length + 1
...
for i in range(7):
  memory_X_train[:, df_train.shape[1] * args.input_length * i: df_train.shape[1] * args.input_length * (i + 1)] = memory_X_train_tmp[:, df_train.shape[1] * 144 * i: df_train.shape[1] * 144 * i + df_train.shape[1] * args.input_length]
  memory_X_valid[:, df_valid.shape[1] * args.input_length * i: df_valid.shape[1] * args.input_length * (i + 1)] = memory_X_valid_tmp[:, df_valid.shape[1] * 144 * i: df_valid.shape[1] * 144 * i + df_valid.shape[1] * args.input_length]
  memory_X_test[:, df_test.shape[1] * args.input_length * i: df_test.shape[1] * args.input_length * (i + 1)] = memory_X_test_tmp[:, df_test.shape[1] * 144 * i: df_test.shape[1] * 144 * i + df_test.shape[1] * args.input_length]

input_X_train = train[:, df_train.shape[1] * 24 * 7 * 6: df_train.shape[1] * 24 * 7 * 6 + df_train.shape[1] * args.input_length]
input_X_valid = valid[:, df_valid.shape[1] * 24 * 7 * 6: df_valid.shape[1] * 24 * 7 * 6 + df_valid.shape[1] * args.input_length]
input_X_test = test[:, df_test.shape[1] * 24 * 7 * 6: df_test.shape[1] * 24 * 7 * 6 + df_test.shape[1] * args.input_length]
y_train = train[:, -1]
y_valid = valid[:, -1]
y_test = test[:, -1]
...
input_1_encoded_m = Conv2D(args.CNN_unit, kernel_size = (args.CNN_kernel, 14), padding = 'valid', activation = 'relu')(input_1)
input_2_encoded_m = Conv2D(args.CNN_unit, kernel_size = (args.CNN_kernel, 14), padding = 'valid', activation = 'relu')(input_2)
input_3_encoded_m = Conv2D(args.CNN_unit, kernel_size = (args.CNN_kernel, 14), padding = 'valid', activation = 'relu')(input_3)
input_4_encoded_m = Conv2D(args.CNN_unit, kernel_size = (args.CNN_kernel, 14), padding = 'valid', activation = 'relu')(input_4)
input_5_encoded_m = Conv2D(args.CNN_unit, kernel_size = (args.CNN_kernel, 14), padding = 'valid', activation = 'relu')(input_5)
input_6_encoded_m = Conv2D(args.CNN_unit, kernel_size = (args.CNN_kernel, 14), padding = 'valid', activation = 'relu')(input_6)
input_7_encoded_m = Conv2D(args.CNN_unit, kernel_size = (args.CNN_kernel, 14), padding = 'valid', activation = 'relu')(input_7)
...
question_encoded = Conv2D(args.CNN_unit, kernel_size = (args.CNN_kernel, 14), padding = 'valid', activation = 'relu')(question)
...
input_1_encoded_c = Conv2D(args.CNN_unit, kernel_size = (args.CNN_kernel, 14), padding = 'valid', activation = 'relu')(input_1)
input_2_encoded_c = Conv2D(args.CNN_unit, kernel_size = (args.CNN_kernel, 14), padding = 'valid', activation = 'relu')(input_2)
input_3_encoded_c = Conv2D(args.CNN_unit, kernel_size = (args.CNN_kernel, 14), padding = 'valid', activation = 'relu')(input_3)
input_4_encoded_c = Conv2D(args.CNN_unit, kernel_size = (args.CNN_kernel, 14), padding = 'valid', activation = 'relu')(input_4)
input_5_encoded_c = Conv2D(args.CNN_unit, kernel_size = (args.CNN_kernel, 14), padding = 'valid', activation = 'relu')(input_5)
input_6_encoded_c = Conv2D(args.CNN_unit, kernel_size = (args.CNN_kernel, 14), padding = 'valid', activation = 'relu')(input_6)
input_7_encoded_c = Conv2D(args.CNN_unit, kernel_size = (args.CNN_kernel, 14), padding = 'valid', activation = 'relu')(input_7)
