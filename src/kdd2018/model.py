...
"""
Read data and merge aq with weather data
"""
...
#Reshape input to (?, feature_sz) and output to (?, 3)
...
#Reshape input to (?, input_length * feature_sz) and output to (?, 3 * 48)
...
#You can design your model here
...
filepath = 'model.h5' #Remember to rename the path of model
...
#Your can rename the filename with different model
filename = 'output.csv'
